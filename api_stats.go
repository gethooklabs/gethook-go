...
func (r ApiGetStatsRequest) Execute() (*StatsData, *http.Response, error) {
...
//  @return StatsData
func (a *StatsAPIService) GetStatsExecute(r ApiGetStatsRequest) (*StatsData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *StatsData
	)
